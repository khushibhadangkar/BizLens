...
export default function AnalyticsIndexPage() {
  ...
  return (
    <div className="max-w-5xl animate-in fade-in duration-500">
      <div className="mb-8">
        <h2 className="text-2xl font-serif tracking-tight text-foreground">Analytics</h2>
        <p className="mt-1 text-sm text-muted-foreground">
          Turn your uploaded data into measurable, traceable decisions.
        </p>
      </div>
      ...
      {isLoading ? (
        ...
        <div className="rounded-xl border border-border bg-surface p-16 text-center flex flex-col items-center">
          ...
          <p className="text-sm text-muted-foreground max-w-xs mb-6">
            Upload and process a dataset to unlock analytics.
          </p>
